...
public class BlockChar {
    ...
    public void buildSingle(String c)
    {
        ...
        try {
            if(bw == null) bw = new BufferedWriter(new FileWriter(this.engine._outputfolder + "charBlock_"+this.engine.id_num+"_" + this.id + "_" + ascii + ".v"));
    ...
    public void buildCharRange ()
    {
        ...
        try {
            if(bw == null) bw = new BufferedWriter(new FileWriter(this.engine._outputfolder + "charBlock_" + this.engine.id_num + "_" + this.id + "_" + "class_word" + ".v"));
            bw.write("module charBlock_" +  this.engine.id_num + "_" + this.id + "(out, char);\n");
    ...
    {
        try {
            if(bw == null) bw = new BufferedWriter(new FileWriter(this.engine._outputfolder + "charBlock_" + this.engine.id_num + "_" + this.id + "_" + "CharClass" + ".v"));
            bw.write("module charBlock_" +  this.engine.id_num + "_" + this.id + "(out, char);\n");
