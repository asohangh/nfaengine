...
public class Element {
	...
	boolean isConcat = false;	//is and element
	boolean isOpt	= false;	//is or element
	boolean isRep	= false; 	//is rep element
	boolean isAtom	= false; 	//is char or char class or parenthesis
