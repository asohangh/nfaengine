...
public class ParseTree {
    ...
    public Node parsePcre(PcreRule rule) {
        ...
        if (temp == null) {
            Refer.println("Something wrong, parse Pcre", null);
            return null;
        }
    ...
    public Node parseConcat(PcreRule rule) {
        ...
        if (temp == null) {
            Refer.println("Somethig wrong, parseConcat", null);
            return null;
        }
    ...
    public void printTreeRecursive(Document doc, Node root, int tab) {
        ...
        Refer.print(tab + ".", doc);
        Refer.println(root.value + "," + Refer.convert[root.id], doc);
