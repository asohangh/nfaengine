...
public class HDL_Generator_v1 {
     ...
     *//*
    private void genSimpleTopModule() {

         BufferedWriter bw = new BufferedWriter(new FileWriter(new File(this.genfolder_verilog + "top_module.v")));
            bw.write("module top_module (o_match,clk,sod,en,char);\n");
            bw.write("\tinput clk, sod, en;\n");
            bw.write("\tinput [7:0] char;\n");
